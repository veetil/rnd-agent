...
export const metadata = {
  title: 'Platform - IdeaCode',
  description: 'Explore the IdeaCode platform features: Model Portability, Orchestration Excellence, Memory Persistence, and Operational Reliability.',
}
  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="h1 mb-6">The IdeaCode Platform</h1>
            <p className="text-xl text-gray-600 mb-8">
              Enterprise-grade orchestration layer for AI agent systems with unmatched reliability, portability, and scalability.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/documentation/getting-started" className="btn text-white bg-blue-600 hover:bg-blue-700">
                Get Started
              </Link>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-5 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="h2 mb-4">Platform Overview</h2>
            <p className="text-lg text-gray-600">
              IdeaCode provides a comprehensive orchestration layer for enterprise AI agent systems, enabling organizations to build, deploy, and manage complex AI workflows with confidence.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="h3 mb-4">Why IdeaCode?</h3>
              ...
              <p className="text-gray-600 mb-6">
                IdeaCode addresses these challenges by providing a unified platform that abstracts away the complexities of different AI models and providers, enables sophisticated orchestration workflows, ensures persistent memory and context management, and delivers enterprise-grade reliability and security.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>Reduce development time by up to 60%</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-blue-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Eliminate vendor lock-in with model portability</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-blue-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Improve reliability with enterprise-grade infrastructure</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-blue-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Enhance user experiences with persistent memory</span>
                </li>
              </ul>
            </div>
            <div className="bg-gray-100 rounded-lg p-6 h-96 flex items-center justify-center">
              {/* Placeholder for platform architecture diagram */}
              <div className="text-center">
                ...
                <p className="text-gray-600">Platform Architecture Diagram</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-5 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="h2 mb-4">Key Differentiators</h2>
            <p className="text-lg text-gray-600">
              Four pillars that make IdeaCode the ideal choice for enterprise AI orchestration.
            </p>
          </div>
